...
NEXT_KANDELO_WORKFLOW_SHA = "c3f91d622c3c878e15783c67e99e483e54ab25c1"
...
CALLER_PROFILES = {
  ...
  "next" => caller_specs_for_sha(NEXT_KANDELO_WORKFLOW_SHA),
}.freeze
...
def self_test(callers, contract, base_contract)
  next_specs = caller_specs_for_sha(NEXT_KANDELO_WORKFLOW_SHA)
...
begin
  ...
  {
    "next" => NEXT_KANDELO_WORKFLOW_SHA,
